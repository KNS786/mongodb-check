...
export const  getRRuleWeekday = (repeatOn: any) => {
    ...
    console.log("RRULEARRAY ::::: => " + rruleArray);
    return rruleArray;
}
...
export const convertToWeekDayArray = (byweekday: any) => {
    ...
    console.log("BYTAWEEK DAY ARRAY :::::: => " + byweekdayArray);
...
export const getWeekdayTimeMap = (dates: any, recurrenceJSON: any) => {
    let weekdayTimeMap:any = new Map();
    let dayCodeTimeMap:any = new Map();
    if (
      dates == null ||
      recurrenceJSON == null ||
    ...
    console.log("WEEK DAY TIME MAP ::::: => " + weekdayTimeMap);
    return weekdayTimeMap;
}
...
export const getRuleParams = (ruleObj: any) => {
    ...
    console.log("RULE OBJECT VALUES ::::: => " + rule);
    return rule;
}
...
export const getRecurrenceValue = (recurrenceJSON: any) => {
    ...
    if (
      ...
      console.log("RECURRANCE FUNCTION VALUES RULE OBJECT :::::: => " + JSON.stringify(ruleObj));
    return ruleObj;
}